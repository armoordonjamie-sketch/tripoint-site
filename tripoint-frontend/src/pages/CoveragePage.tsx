            ...
            <Section>
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-4 max-w-2xl text-lg text-text-secondary">
                        We cover up to 60 minutes drive time from our active base that week. Your zone determines your pricing.
                    </p>
                </div>

                {/* Weekly base rotation */}
                <div className="mx-auto mt-12 max-w-3xl">
                    <h2 className="mb-6 text-2xl font-bold text-text-primary">Weekly Base Rotation</h2>
                    <div className="grid gap-4 sm:grid-cols-3">
                        {Object.values(siteConfig.baseLocations).map((loc) => (
                            <div key={loc.label} className="rounded-2xl border border-border-default bg-surface-alt p-5">
                                ...
                                <div className="space-y-2 text-sm text-text-secondary">
                                    ...
                                    <p className="text-xs text-text-muted">{loc.note}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="mx-auto mt-12 max-w-3xl">
                    ...
                    <p className="mb-4 text-text-secondary">
                        Zones are calculated by one-way drive time from the active base that week, using Google or Apple Maps at the time of booking.
                    </p>
                ...
                <div className="mx-auto mt-12 max-w-3xl">
                    ...
                    <p className="mt-4 text-sm text-text-muted">
                        This is not an exhaustive list. If you&apos;re within 60 minutes drive of our active base that week, we can likely reach you.
                    </p>
                </div>
