    ...
    return (
        <div ref={scrollRef}>
            ...
            <section className="relative h-72 sm:h-96 overflow-hidden">
                <OptimizedImage src="/images/new-images/sprinter-brakes-hero.jpg" alt="Mercedes Vito brake service by TriPoint" className="h-full w-full object-cover" priority />
