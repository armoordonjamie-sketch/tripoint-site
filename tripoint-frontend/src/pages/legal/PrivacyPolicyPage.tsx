                    ...
                    <div className="mt-8 space-y-8 text-text-secondary">
                        ...
                        <section>
                            ...
                            <ul className="mt-2 list-inside list-disc space-y-1">
                                ...
                                <li><strong>Analytics:</strong> We use Google Analytics 4 to measure site usage (e.g. page views, form submissions, phone and WhatsApp clicks). Google may use cookies and collect data as described in <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:underline">Google&apos;s Privacy Policy</a>.</li>
