...
export const routeManifest: RouteEntry[] = [
    ...
    // Services
    {
        ...
        canonicalPath: '/services/mercedes-xentry-diagnostics-coding',
        priority: 0.8,
        changefreq: 'weekly',
        indexable: true,
    },
    {
        ...
        canonicalPath: '/services/mobile-fault-finding',
        priority: 0.8,
        changefreq: 'weekly',
        indexable: true,
    },
    {
        ...
        canonicalPath: '/services/dpf-regeneration-and-diagnostics',
        priority: 0.8,
        changefreq: 'weekly',
        indexable: true,
    },
    {
        ...
        canonicalPath: '/services/adblue-scr-diagnostics',
        priority: 0.8,
        changefreq: 'weekly',
        indexable: true,
    },
    {
        ...
        canonicalPath: '/services/ecu-coding-and-variant-coding',
        priority: 0.8,
        changefreq: 'weekly',
        indexable: true,
    },
    {
        ...
        description:
            'Standard mobile diagnostic callout. Up to 60 minutes on-site. Dealer-level fault finding at your location.',
    ...
    },
    {
        ...
        description:
            'VOR and priority triage for commercial vehicles. Faster response for off-road vans and fleet diagnostics.',
    ...
    },
    {
        ...
        canonicalPath: '/services/emissions-diagnostics',
        priority: 0.8,
        changefreq: 'weekly',
        indexable: true,
    },
    ...
    },
    {
        ...
        canonicalPath: '/services/sprinter-limp-mode',
        priority: 0.8,
        changefreq: 'weekly',
        indexable: true,
    },
    {
        ...
        canonicalPath: '/services/adblue-countdown',
        priority: 0.8,
        changefreq: 'weekly',
        indexable: true,
    },
    {
        ...
        canonicalPath: '/services/nox-scr-diagnostics',
        priority: 0.8,
        changefreq: 'weekly',
        indexable: true,
    },
    {
        ...
        canonicalPath: '/services/dpf-regeneration-decision',
        priority: 0.8,
        changefreq: 'weekly',
        indexable: true,
    },
    {
        ...
        canonicalPath: '/services/intermittent-electrical-faults',
        priority: 0.8,
        changefreq: 'weekly',
        indexable: true,
    },
    {
        ...
        canonicalPath: '/services/fleet-health-check',
        priority: 0.8,
        changefreq: 'weekly',
        indexable: true,
    },
