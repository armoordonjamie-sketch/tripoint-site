...
export function ServiceCard({
    ...
    return (
        <Link
            to={href}
            className={cn(
                'group relative flex flex-col rounded-2xl p-6 transition-[transform,box-shadow,border-color] duration-300',
        ...
        >
            {/* Glow on hover */}
            <div className="pointer-events-none absolute -inset-px rounded-2xl bg-brand/0 transition-colors duration-300 group-hover:bg-brand/3" aria-hidden="true" />
            ...
            <div className="relative">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <span className="flex items-center gap-1 text-sm font-medium text-text-muted transition-colors group-hover:text-brand group-hover:gap-2">
                        Learn more
