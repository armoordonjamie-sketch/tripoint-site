...
replacements = {
    ...
    "[DEPOSIT_CREDIT_HTML]": """
        <tr>
            <td colspan="3" style="text-align:right;padding-top:12px;padding-bottom:12px;">
                Less Deposit Paid (10 Apr 2026):<br>
                <span style="font-size:12px;color:#6b7280;">Mastercard &bull;&bull;&bull;&bull; 7042</span>
            </td>
            <td style="text-align:right;padding-top:12px;padding-bottom:12px;color:#059669;font-weight:600;">
                -&pound;30.00
            </td>
        </tr>""",
    "[CLIENT_FULL_NAME]": "Harry Richards",
    "[CLIENT_EMAIL]": "s.richards98@ntlworld.com",
    "[CLIENT_PHONE]": "",
    "[BILL_TO_ADDRESS]": "98 Glenhurst Avenue\nBexley\nDA5 3QN",
    ...
    "[NOTES]": "<p><strong>Notes:</strong> Standard diagnosis on GL64OJB. Initial deposit of &pound;30.00 paid via Stripe Checkout on 10 April 2026. Remaining balance of &pound;90.00 paid via Stripe Terminal (Visa &bull;&bull;&bull;&bull; 2482) on 11 April 2026. Invoice settled in full.</p>"
        "",
    "[FOOTER_EXTRA]": "",
...
print(f"Customer: Harry Richards (DA5 3QN)")
print(f"Vehicle: GL64OJB")
print(f"Total inc VAT:      GBP120.00")
print(f"Amount Paid:        GBP120.00 (£30 deposit + £90 balance)")
print(f"Balance Due:        GBP0.00 (PAID IN FULL)")
print(f"{'='*60}")
