...
INVOICE_ID = "TPD-2026-0023"
INVOICE_DATE = "3 May 2026"
DUE_DATE = "3 May 2026"
TOTAL_PENCE = 11579  # £115.79
...
product = stripe.Product.create(
    name=f"Invoice {INVOICE_ID} – CV Boot Replacement",
    description="Mercedes-Benz V-Class W447 (K9 DDH) - OSR Outer CV Boot Replacement",
)
...
line_items_html = """
                ...
                <tr>
                    <td>
                        <strong>Genuine Mercedes CV Boot Repair Kit</strong><br>
                        <span style="font-size:12px;color:#6b7280;">Outer CV joint repair kit for OSR (Off-Side Rear) half shaft.</span>
                    </td>
                    <td style="text-align:center;">1</td>
                    <td style="text-align:right;">&pound;28.49</td>
                    <td style="text-align:right;">&pound;28.49</td>
                </tr>
                <tr style="background:#f0f9ff;">
                ...
                <tr>
                    <td>
                        <strong>Mobile Callout &amp; CV Boot Installation</strong><br>
                        <span style="font-size:12px;color:#6b7280;">Travel to customer location and remove/refit outer CV boot on OSR half shaft (approx. 45 mins).</span>
                    </td>
                    <td style="text-align:center;">1</td>
...
replacements = {
    ...
    "Diagnostic visit completion": "OSR Outer CV Boot Replacement",
    ...
    "[SUBTOTAL]": "&pound;113.49",
    "[DISCOUNT]": "-&pound;17.00 (20% off labour)",
    "[VAT_RATE]": "20%",
    "[VAT_AMOUNT]": "&pound;19.30",
    "[TOTAL]": "&pound;115.79",
    "[AMOUNT_PAID]": "&pound;0.00",
    "[BALANCE_DUE]": "&pound;115.79",
    ...
    "[PAYMENT_LINK]": f'<a href="{PAYMENT_URL}" class="pay-btn" style="color:#fff !important;">Pay &pound;115.79 Online &rarr;</a>',
    "[NOTES]": "<p><strong>Notes:</strong> Outer CV boot replaced on 3 May 2026 as per Estimate EST-2026-0010. 20% discount applied on labour.</p>",
    "[FOOTER_EXTRA]": "",
...
print(f"Subtotal:     GBP113.49")
print(f"Discount:    -GBP17.00")
print(f"VAT (20%):    GBP19.30")
print(f"Total:        GBP115.79")
