                ...
                <tr>
                    <td>
                        ...
                        <span style="font-size:12px;color:#6b7280;">
                            Labour provision (2 hours @ &pound;20.50/hr).<br>
                            Reference: TPD-2026-0022
                        </span>
                    </td>
                    <td style="text-align:center;">2</td>
                    <td style="text-align:right;">&pound;20.50</td>
                    <td style="text-align:right;">&pound;41.00</td>
                </tr>
"""
...
replacements = {
    ...
    "[STATUS]": "PAID OUT",
    "[DEPOSIT_CREDIT_HTML]": "",
    "[CLIENT_FULL_NAME]": "Aaron Douglas",
    "[CLIENT_EMAIL]": "",
    "[CLIENT_PHONE]": "",
    "[BILL_TO_ADDRESS]": "Address on file",
    "[SERVICE_ADDRESS]": "Tripoint Diagnostics Ltd\n476 Sidcup Road\nLondon, SE9 4HA",
    "[VEHICLE_MAKE_MODEL]": "-",
    "[VEHICLE_REG]": "-",
    "[ODOMETER]": "-",
    "[JOB_ID]": "TPD-2026-0022",
    "[PO_NUMBER]": "-",
    "[TECH_NAME]": "Aaron Douglas",
    "[LINE_ITEMS_HTML]": line_items_html,
    "[SUBTOTAL]": "&pound;41.00",
    "[DISCOUNT]": "None",
    "[VAT_RATE]": "0%",
    "[VAT_AMOUNT]": "&pound;0.00",
    "[TOTAL]": "&pound;41.00",
    "[AMOUNT_PAID]": "&pound;41.00",
    "[BALANCE_DUE]": "&pound;0.00",
    "[PAYMENT_METHODS]": "Payment has been processed successfully via bank transfer.",
    "[BANK_DETAILS]": "",
    "[PAYMENT_LINK]": "",
    "[NOTES]": "<p><strong>Notes:</strong> This document serves as confirmation that TriPoint Diagnostics Ltd has processed a bank transfer of &pound;41.00 to you for the referenced subcontractor work.</p>",
    "[FOOTER_EXTRA]": "",
...
print(f"Paid To: Aaron Douglas")
print(f"Amount: GBP41.00")
print(f"Date: 30 April 2026")
print(f"Ref: TPD-2026-0022")
print(f"{'='*60}")
